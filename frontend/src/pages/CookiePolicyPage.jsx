...
export default function CookiePolicyPage() {
  return (
    ...
    >
      ...
      >
        <p>We may update this Cookie Policy to reflect changes in our practices or the law. The “Updated” date at the top will change. For how we process personal data overall, see our <strong>Privacy Policy</strong>. Questions: <strong>support@prakritimitra.me</strong>.</p>
      </PolicySection>
    </PolicyPageLayout>
  );
}
