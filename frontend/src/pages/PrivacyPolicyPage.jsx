  ...
  return (
    ...
    >
      <PolicySection
        id="intro"
        title="Introduction"
        inShort="By using PrakritiMitra, you agree to how we collect and use your information as described here."
        defaultOpen
      >
        <p>
          PrakritiMitra helps you discover environmental events, volunteer, and connect with organizations. This policy explains what data we collect, why, and how you can control it. If you don’t agree, please don’t use our services.
        </p>
      </PolicySection>
      ...
      >
        <p>Depending on where you live, you may have rights to access, correct, delete, or port your data. You can update your profile and preferences in account settings. For other requests: <strong>support@prakritimitra.me</strong>.</p>
      </PolicySection>
