...
export default function TermsOfServicePage() {
  return (
    <PolicyPageLayout
      ...
      subtitle="The rules of the road for using PrakritiMitra."
    ...
    >
      <PolicySection
        id="acceptance"
        title="Acceptance"
        inShort="By using PrakritiMitra, you agree to these terms. If you’re using it for an organization, you have authority to bind them."
        defaultOpen
      >
        <p>By accessing or using PrakritiMitra, you agree to these Terms. We connect volunteers with environmental organizations and events; use must be lawful and aligned with that mission.</p>
      </PolicySection>
      ...
      >
        <p>Organizers are responsible for event details, safety at events, and local laws. You own your content but grant us a license to use it to operate and promote PrakritiMitra. We may remove content that violates these terms.</p>
      </PolicySection>
      ...
      >
        <p>To the maximum extent permitted by law, PrakritiMitra is not liable for indirect, incidental, special, or consequential damages. Our total liability shall not exceed the amount you paid us in the 12 months before the claim (if any).</p>
      </PolicySection>
      ...
      <PolicySection
        id="contact"
        title="Contact"
        inShort="Questions? support@prakritimitra.me. Governing law and dispute resolution depend on your jurisdiction."
      >
        <p>For questions about these Terms: <strong>support@prakritimitra.me</strong>. Governing law and dispute resolution are as specified for your jurisdiction.</p>
      </PolicySection>
    </PolicyPageLayout>
  );
}
