      ...
      },
      {
        ...
        handler: async () => {
          try {
            ...
            return `You joined PrakritiMitra on ${joinDate}. That's ${daysSinceJoin} days of being part of our community! Thank you for your dedication to environmental causes.`;
          } catch (error) {
